<script>
  ...
  import { X, QR, QRCode, Share, Floppy, Transfer, Mobile, Desktop } from '$icons'
...
<section>
  <IconButton
      rounded borderless color=orange containerClassName='absolute top-4 right-4'
  ...
  {:else}
    <div class='h-32 mt-8'>
      ...
      <i class='text-lg opacity-50 absolute bottom-10 left-1/2 -translate-x-1/2'> Importing... </i>
    </div>
  {/if}
