...
<style>
  footer { @apply text-center w-full absolute bottom-12 md:bottom-0 sm:my-6 px-4 text-tiny md:text-xs text-gray-500 dark:text-gray-400 leading-3 pointer-events-none -z-10; }
